...
### GET_CUSTOMER_LIST
  ...
  - Initialized with `client_attrs = { access_token: "access_token1", customer_list_id: "wy3xz" }`
    ```
    HubriseClient::V1.new(client_attrs).get_customer_list()
    // => [GET] /customer_lists/wy3xz with { headers: { "X-Access-Token": "access_token1" }}
    ```
### GET_ALL_CUSTOMERS
  - Initialized with `client_attrs = { access_token: "access_token1" }`
    ```
    HubriseClient::V1.new(client_attrs).get_all_customers("zrn61")
    // => [GET] /customer_lists/zrn61/customers with { headers: { "X-Access-Token": "access_token1" }}
    ```
  - Initialized with `client_attrs = { access_token: "access_token1", customer_list_id: "wy3xz" }`
    ```
    HubriseClient::V1.new(client_attrs).get_all_customers()
...
### GET_LOCATION_CATALOGS
  - Initialized with `client_attrs = { access_token: "access_token1" }`
    ```
    HubriseClient::V1.new(client_attrs).get_location_catalogs("zrn61")
    // => [GET] /locations/zrn61/catalogs with { headers: { "X-Access-Token": "access_token1" }}
    ```
### GET_ACCOUNT_CATALOGS
  - Initialized with `client_attrs = { access_token: "access_token1" }`
    ```
    HubriseClient::V1.new(client_attrs).get_account_catalogs("zrn61")
    // => [GET] /accounts/zrn61/catalogs with { headers: { "X-Access-Token": "access_token1" }}
    ```
### GET_CATALOG
  - Initialized with `client_attrs = { access_token: "access_token1" }`
    ```
    HubriseClient::V1.new(client_attrs).get_catalog("zrn61")
...
### CREATE_LOYALTY_CARD
  - Initialized with `client_attrs = { access_token: "access_token1" }`
    ```
    HubriseClient::V1.new(client_attrs).create_loyalty_card({ name: "bonus" }, "wy3xz")
  ...
  - Initialized with `client_attrs = { access_token: "access_token1", customer_list_id: "zrk6b" }`
    ```
    HubriseClient::V1.new(client_attrs).create_loyalty_card({ name: "bonus" })
...
### CREATE_LOYALTY_OPERATION
  - Initialized with `client_attrs = { access_token: "access_token1" }`
    ```
    HubriseClient::V1.new(client_attrs).create_loyalty_operation("zrk6b", { delta: "4.2" }, "wy3xz")
  ...
  - Initialized with `client_attrs = { access_token: "access_token1", customer_list_id: "q2brk" }`
    ```
    HubriseClient::V1.new(client_attrs).create_loyalty_operation("zrk6b", { delta: "4.2" })
